...
function delete_graphql_api(apiId; aws_config::AbstractAWSConfig=global_aws_config())
    return appsync(
        "DELETE", "/v1/apis/$(apiId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_graphql_api(apiId; aws_config::AbstractAWSConfig=global_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_graphql_api(
    ...
    return appsync(
        "GET", "/v1/apis/$(apiId)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_api_keys(apiId; aws_config::AbstractAWSConfig=global_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)/apikeys"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_graphql_apis(; aws_config::AbstractAWSConfig=global_aws_config())
    return appsync("GET", "/v1/apis"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_graphql_apis(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return appsync(
        "GET", "/v1/apis", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
