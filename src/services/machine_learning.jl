...
function describe_batch_predictions(; aws_config::AbstractAWSConfig=global_aws_config())
    return machine_learning(
        "DescribeBatchPredictions"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_batch_predictions(
    ...
    return machine_learning(
        "DescribeBatchPredictions", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_data_sources(; aws_config::AbstractAWSConfig=global_aws_config())
    return machine_learning(
        "DescribeDataSources"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_data_sources(
    ...
    return machine_learning(
        "DescribeDataSources", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_evaluations(; aws_config::AbstractAWSConfig=global_aws_config())
    return machine_learning(
        "DescribeEvaluations"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_evaluations(
    ...
    return machine_learning(
        "DescribeEvaluations", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_mlmodels(; aws_config::AbstractAWSConfig=global_aws_config())
    return machine_learning(
        "DescribeMLModels"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_mlmodels(
    ...
    return machine_learning(
        "DescribeMLModels", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
