...
function get_service_role_for_account(; aws_config::AbstractAWSConfig=global_aws_config())
    return greengrass(
        "GET", "/greengrass/servicerole"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return greengrass(
        "GET", "/greengrass/groups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function tag_resource(resource_arn; aws_config::AbstractAWSConfig=global_aws_config())
    return greengrass(
        "POST", "/tags/$(resource-arn)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
