...
function get_account_settings(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("GetAccountSettings"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function list_environment_templates(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton(
        "ListEnvironmentTemplates"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_environment_templates(
    ...
    return proton(
        "ListEnvironmentTemplates", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_environments(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("ListEnvironments"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function list_service_instances(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("ListServiceInstances"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_service_instances(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return proton(
        "ListServiceInstances", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_service_templates(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("ListServiceTemplates"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_service_templates(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return proton(
        "ListServiceTemplates", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_services(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("ListServices"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_services(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return proton("ListServices", params; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function update_account_settings(; aws_config::AbstractAWSConfig=global_aws_config())
    return proton("UpdateAccountSettings"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function update_account_settings(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return proton(
        "UpdateAccountSettings", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
