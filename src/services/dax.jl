...
function describe_clusters(; aws_config::AbstractAWSConfig=global_aws_config())
    return dax("DescribeClusters"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function describe_clusters(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return dax("DescribeClusters", params; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_default_parameters(; aws_config::AbstractAWSConfig=global_aws_config())
    return dax(
        "DescribeDefaultParameters"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_events(; aws_config::AbstractAWSConfig=global_aws_config())
    return dax("DescribeEvents"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function describe_events(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return dax("DescribeEvents", params; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_parameter_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return dax("DescribeParameterGroups"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_subnet_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return dax("DescribeSubnetGroups"; aws_config=aws_config, features=SERVICE_FEATURES)
end
