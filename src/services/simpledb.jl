...
function list_domains(; aws_config::AbstractAWSConfig=global_aws_config())
    return simpledb("ListDomains"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_domains(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return simpledb("ListDomains", params; aws_config=aws_config, features=SERVICE_FEATURES)
end
