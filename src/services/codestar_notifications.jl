...
function list_event_types(; aws_config::AbstractAWSConfig=global_aws_config())
    return codestar_notifications(
        "POST", "/listEventTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_event_types(
    ...
    return codestar_notifications(
        "POST", "/listEventTypes", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_notification_rules(; aws_config::AbstractAWSConfig=global_aws_config())
    return codestar_notifications(
        "POST", "/listNotificationRules"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_targets(; aws_config::AbstractAWSConfig=global_aws_config())
    return codestar_notifications(
        "POST", "/listTargets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_targets(
    ...
    return codestar_notifications(
        "POST", "/listTargets", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
