...
function list_applications(; aws_config::AbstractAWSConfig=global_aws_config())
    return application_insights(
        "ListApplications"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_configuration_history(; aws_config::AbstractAWSConfig=global_aws_config())
    return application_insights(
        "ListConfigurationHistory"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_configuration_history(
    ...
    return application_insights(
        "ListConfigurationHistory", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_problems(; aws_config::AbstractAWSConfig=global_aws_config())
    return application_insights(
        "ListProblems"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_problems(
    ...
    return application_insights(
        "ListProblems", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
