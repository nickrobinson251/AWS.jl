...
function describe_dbclusters(; aws_config::AbstractAWSConfig=global_aws_config())
    return neptune("DescribeDBClusters"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_dbinstances(; aws_config::AbstractAWSConfig=global_aws_config())
    return neptune("DescribeDBInstances"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_dbsubnet_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return neptune(
        "DescribeDBSubnetGroups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_events(; aws_config::AbstractAWSConfig=global_aws_config())
    return neptune("DescribeEvents"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function failover_dbcluster(; aws_config::AbstractAWSConfig=global_aws_config())
    return neptune("FailoverDBCluster"; aws_config=aws_config, features=SERVICE_FEATURES)
end
