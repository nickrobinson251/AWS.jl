...
function get_findings_report_account_summary(;
    ...
    return codeguruprofiler(
        "GET", "/internal/findingsReports"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_findings_report_account_summary(
...
function list_profiling_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return codeguruprofiler(
        "GET", "/profilingGroups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_profiling_groups(
    ...
    return codeguruprofiler(
        "GET", "/profilingGroups", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
