...
function delete_registry_policy(; aws_config::AbstractAWSConfig=global_aws_config())
    return ecr("DeleteRegistryPolicy"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function delete_registry_policy(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return ecr(
        "DeleteRegistryPolicy", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_registry(; aws_config::AbstractAWSConfig=global_aws_config())
    return ecr("DescribeRegistry"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function describe_registry(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return ecr("DescribeRegistry", params; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_repositories(; aws_config::AbstractAWSConfig=global_aws_config())
    return ecr("DescribeRepositories"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function describe_repositories(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return ecr(
        "DescribeRepositories", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_authorization_token(; aws_config::AbstractAWSConfig=global_aws_config())
    return ecr("GetAuthorizationToken"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function get_authorization_token(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return ecr(
        "GetAuthorizationToken", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_registry_policy(; aws_config::AbstractAWSConfig=global_aws_config())
    return ecr("GetRegistryPolicy"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function get_registry_policy(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return ecr(
        "GetRegistryPolicy", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
