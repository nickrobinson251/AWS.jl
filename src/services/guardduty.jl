...
function get_detector(detectorId; aws_config::AbstractAWSConfig=global_aws_config())
    return guardduty(
        "GET", "/detector/$(detectorId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_invitations_count(; aws_config::AbstractAWSConfig=global_aws_config())
    return guardduty(
        "GET", "/invitation/count"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_invitations_count(
    ...
    return guardduty(
        "GET", "/invitation/count", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_detectors(; aws_config::AbstractAWSConfig=global_aws_config())
    return guardduty("GET", "/detector"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_detectors(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return guardduty(
        "GET", "/detector", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_invitations(; aws_config::AbstractAWSConfig=global_aws_config())
    return guardduty("GET", "/invitation"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_invitations(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return guardduty(
        "GET", "/invitation", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_organization_admin_accounts(;
    ...
    return guardduty("GET", "/admin"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_organization_admin_accounts(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return guardduty(
        "GET", "/admin", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function update_detector(detectorId; aws_config::AbstractAWSConfig=global_aws_config())
    return guardduty(
        "POST", "/detector/$(detectorId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
