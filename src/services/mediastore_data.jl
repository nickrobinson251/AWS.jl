...
function delete_object(Path; aws_config::AbstractAWSConfig=global_aws_config())
    return mediastore_data(
        "DELETE", "/$(Path)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function delete_object(
    ...
    return mediastore_data(
        "DELETE", "/$(Path)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_object(Path; aws_config::AbstractAWSConfig=global_aws_config())
    return mediastore_data(
        "HEAD", "/$(Path)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_object(
    ...
    return mediastore_data(
        "HEAD", "/$(Path)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_object(Path; aws_config::AbstractAWSConfig=global_aws_config())
    return mediastore_data(
        "GET", "/$(Path)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_object(
    Path, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
    ...
    return mediastore_data(
        "GET", "/$(Path)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_items(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediastore_data("GET", "/"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_items(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return mediastore_data(
        "GET", "/", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
