...
function get_change_token(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional("GetChangeToken"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function get_change_token(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return waf_regional(
        "GetChangeToken", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_byte_match_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListByteMatchSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_geo_match_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListGeoMatchSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_geo_match_sets(
    ...
    return waf_regional(
        "ListGeoMatchSets", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_ipsets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional("ListIPSets"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_ipsets(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return waf_regional(
        "ListIPSets", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_rate_based_rules(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListRateBasedRules"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_regex_match_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListRegexMatchSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_regex_pattern_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListRegexPatternSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_rule_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional("ListRuleGroups"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_rule_groups(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return waf_regional(
        "ListRuleGroups", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_rules(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional("ListRules"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_rules(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
...
function list_size_constraint_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListSizeConstraintSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_subscribed_rule_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListSubscribedRuleGroups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_web_acls(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional("ListWebACLs"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_web_acls(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return waf_regional(
        "ListWebACLs", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_xss_match_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return waf_regional(
        "ListXssMatchSets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_xss_match_sets(
    ...
    return waf_regional(
        "ListXssMatchSets", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
