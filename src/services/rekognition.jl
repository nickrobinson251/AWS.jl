...
function describe_projects(; aws_config::AbstractAWSConfig=global_aws_config())
    return rekognition("DescribeProjects"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function describe_projects(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return rekognition(
        "DescribeProjects", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_collections(; aws_config::AbstractAWSConfig=global_aws_config())
    return rekognition("ListCollections"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_collections(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return rekognition(
        "ListCollections", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_stream_processors(; aws_config::AbstractAWSConfig=global_aws_config())
    return rekognition(
        "ListStreamProcessors"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_stream_processors(
    ...
    return rekognition(
        "ListStreamProcessors", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
