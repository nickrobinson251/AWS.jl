...
function delete_asset(id; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "DELETE", "/assets/$(id)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function delete_asset(
    ...
    return mediapackage_vod(
        "DELETE", "/assets/$(id)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_asset(id; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "GET", "/assets/$(id)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_asset(
    ...
    return mediapackage_vod(
        "GET", "/assets/$(id)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_packaging_group(id; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "GET", "/packaging_groups/$(id)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_assets(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "GET", "/assets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_packaging_configurations(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "GET", "/packaging_configurations"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_packaging_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "GET", "/packaging_groups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_packaging_groups(
    ...
    return mediapackage_vod(
        "GET", "/packaging_groups", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function update_packaging_group(id; aws_config::AbstractAWSConfig=global_aws_config())
    return mediapackage_vod(
        "PUT", "/packaging_groups/$(id)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
