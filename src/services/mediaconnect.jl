...
function delete_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "DELETE", "/v1/flows/$(flowArn)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "GET", "/v1/flows/$(flowArn)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_entitlements(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "GET", "/v1/entitlements"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_entitlements(
    ...
    return mediaconnect(
        "GET", "/v1/entitlements", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_flows(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "GET", "/v1/flows"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_flows(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
    ...
    return mediaconnect(
        "GET", "/v1/flows", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_offerings(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "GET", "/v1/offerings"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_offerings(
    ...
    return mediaconnect(
        "GET", "/v1/offerings", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_reservations(; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "GET", "/v1/reservations"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_reservations(
    ...
    return mediaconnect(
        "GET", "/v1/reservations", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function update_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config())
    return mediaconnect(
        "PUT", "/v1/flows/$(flowArn)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
