...
function list_application_states(; aws_config::AbstractAWSConfig=global_aws_config())
    return migration_hub(
        "ListApplicationStates"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_application_states(
    ...
    return migration_hub(
        "ListApplicationStates", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_migration_tasks(; aws_config::AbstractAWSConfig=global_aws_config())
    return migration_hub(
        "ListMigrationTasks"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_migration_tasks(
    ...
    return migration_hub(
        "ListMigrationTasks", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_progress_update_streams(; aws_config::AbstractAWSConfig=global_aws_config())
    return migration_hub(
        "ListProgressUpdateStreams"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
