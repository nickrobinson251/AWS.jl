...
function cancel_job(JobId; aws_config::AbstractAWSConfig=global_aws_config())
    return dataexchange(
        "DELETE", "/v1/jobs/$(JobId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function cancel_job(
...
function get_job(JobId; aws_config::AbstractAWSConfig=global_aws_config())
    return dataexchange(
        "GET", "/v1/jobs/$(JobId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_job(
    JobId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
    ...
    return dataexchange(
        "GET", "/v1/jobs/$(JobId)", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_data_sets(; aws_config::AbstractAWSConfig=global_aws_config())
    return dataexchange(
        "GET", "/v1/data-sets"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_data_sets(
    ...
    return dataexchange(
        "GET", "/v1/data-sets", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_jobs(; aws_config::AbstractAWSConfig=global_aws_config())
    return dataexchange("GET", "/v1/jobs"; aws_config=aws_config, features=SERVICE_FEATURES)
end
function list_jobs(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return dataexchange(
        "GET", "/v1/jobs", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function start_job(JobId; aws_config::AbstractAWSConfig=global_aws_config())
    return dataexchange(
        "PATCH", "/v1/jobs/$(JobId)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function start_job(
    JobId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
