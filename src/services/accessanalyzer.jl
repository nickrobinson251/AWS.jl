...
function get_analyzer(analyzerName; aws_config::AbstractAWSConfig=global_aws_config())
    return accessanalyzer(
        "GET", "/analyzer/$(analyzerName)"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_analyzers(; aws_config::AbstractAWSConfig=global_aws_config())
    return accessanalyzer(
        "GET", "/analyzer"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_analyzers(
    ...
    return accessanalyzer(
        "GET", "/analyzer", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_policy_generations(; aws_config::AbstractAWSConfig=global_aws_config())
    return accessanalyzer(
        "GET", "/policy/generation"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
