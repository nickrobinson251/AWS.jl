...
function get_account(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/account"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function get_account(
    ...
    return sesv2(
        "GET", "/v2/email/account", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function get_dedicated_ips(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/dedicated-ips"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_contact_lists(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/contact-lists"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_email_identities(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/identities"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_email_templates(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/templates"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_import_jobs(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "GET", "/v2/email/import-jobs"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function put_account_sending_attributes(; aws_config::AbstractAWSConfig=global_aws_config())
    return sesv2(
        "PUT", "/v2/email/account/sending"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
