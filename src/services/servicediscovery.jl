...
function list_namespaces(; aws_config::AbstractAWSConfig=global_aws_config())
    return servicediscovery(
        "ListNamespaces"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function list_namespaces(
    ...
    return servicediscovery(
        "ListNamespaces", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function list_services(; aws_config::AbstractAWSConfig=global_aws_config())
    return servicediscovery(
        "ListServices"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
