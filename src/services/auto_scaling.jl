...
function describe_adjustment_types(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeAdjustmentTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_adjustment_types(
    ...
    return auto_scaling(
        "DescribeAdjustmentTypes", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_auto_scaling_groups(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeAutoScalingGroups"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_auto_scaling_instances(;
    ...
    return auto_scaling(
        "DescribeAutoScalingInstances"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_auto_scaling_instances(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
...
function describe_launch_configurations(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeLaunchConfigurations"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_lifecycle_hook_types(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeLifecycleHookTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_metric_collection_types(;
    ...
    return auto_scaling(
        "DescribeMetricCollectionTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_metric_collection_types(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
...
function describe_policies(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribePolicies"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_policies(
    ...
    return auto_scaling(
        "DescribePolicies", params; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_scaling_activities(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeScalingActivities"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_scaling_process_types(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling(
        "DescribeScalingProcessTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
...
function describe_tags(; aws_config::AbstractAWSConfig=global_aws_config())
    return auto_scaling("DescribeTags"; aws_config=aws_config, features=SERVICE_FEATURES)
end
...
function describe_termination_policy_types(;
    ...
    return auto_scaling(
        "DescribeTerminationPolicyTypes"; aws_config=aws_config, features=SERVICE_FEATURES
    )
end
function describe_termination_policy_types(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
